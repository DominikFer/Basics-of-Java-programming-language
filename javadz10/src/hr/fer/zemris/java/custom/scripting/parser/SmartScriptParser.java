...
public class SmartScriptParser {
	...
	private Token getToken(String token) throws SmartScriptParserException {
		if(token.equals("+") || token.equals("-") || token.equals("*") || token.equals("/")) {
			...
			return new TokenConstantString(token.replace("\"", ""));
			    	...
			    	case NODE_COMMAND:
			    		if (c == ' ') {
			    			...
			    			if(builder.toString().equals("FOR")) {
			    				...
			    				throw new SmartScriptParserException("Unknown command '" + builder.toString() + "'.");
			    			}
			    		} else if(Character.isLetter(c)) {
			    			builder.append(c);
			    		} else if(c == '$') {
			    			...
			    			throw new SmartScriptParserException("Command '" + builder.toString() + "' exception. Command can contain only letters.");
			    		}
			    	break;
			    	case NODE_END:
			    		if (c == ' ') {
