...
/**
 *	Class which executes the obtained parsed document tree.
 */
public class SmartScriptEngine {
	...
	private INodeVisitor visitor = new INodeVisitor() {
		...
		public void visitTextNode(TextNode node) {
			try {
				...
				System.out.println("Could not write to the outputStream of 'requestContext'.");
			}
		}
	 ...
	 * Constructor.
	 * 
	 * @param documentNode		Parsed document tree.
	 * @param requestContext	Context used to write out the executed document.
	 */
	...
	/**
	 * Runs the engine (document) execution.
	 */
	public void execute() {
